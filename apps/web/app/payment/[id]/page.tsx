...
export default function PaymentPage() {
  ...
  if (loading) {
    return <main className="mx-auto max-w-lg p-8">Loading payment...</main>;
  }
  ...
  const upiName = process.env.NEXT_PUBLIC_UPI_NAME ?? "Wholesale Store";
